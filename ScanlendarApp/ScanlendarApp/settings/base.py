"""
Django settings for ScanlendarApp project.
...
ROOT_URLCONF = 'ScanlendarApp.urls'
...
WSGI_APPLICATION = 'ScanlendarApp.wsgi.application'
...
WAGTAIL_SITE_NAME = 'ScanlendarApp'
